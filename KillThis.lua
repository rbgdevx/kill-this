...
local function addBanner(nameplate, guid)
  ...
  local anchorFrame = NS.db.general.attachToHealthBar and GetAnchorFrame(nameplate) or nameplate
  nameplate.killThisBanner:ClearAllPoints()
  nameplate.killThisBanner:SetPoint("BOTTOM", anchorFrame, "TOP", NS.OFFSET.x, NS.OFFSET.y)
